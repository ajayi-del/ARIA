...
class FundingRadar:
    ...
    def build_snapshot(self, symbol: str) -> FundingSnapshot:
        ...
        # Note: SoDEX funding rates can be very small (e.g. 1.25e-05 = 0.00125% hourly).
        # This is a valid near-zero rate — do NOT substitute with synthetic trade-flow rates.
        # Synthetic rates (up to ±0.10) are far larger and would produce misleading display.
